...
namespace ShopMagicVendor\Getresponse\Sdk\Operation\FileLibrary\Folders\CreateFolder;
...
use ShopMagicVendor\Getresponse\Sdk\Operation\Model\NewFolder;
class CreateFolder extends CommandOperation
{
    ...
    protected $data;
    /**
     * @param NewFolder $data
     */
    public function __construct(NewFolder $data)
    {
        $this->data = $data;
    }
    /**
