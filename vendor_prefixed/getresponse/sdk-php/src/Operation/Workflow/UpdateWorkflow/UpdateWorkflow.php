...
namespace ShopMagicVendor\Getresponse\Sdk\Operation\Workflow\UpdateWorkflow;
...
use ShopMagicVendor\Getresponse\Sdk\Operation\Model\UpdateWorkflow as ModelUpdateWorkflow;
class UpdateWorkflow extends CommandOperation
{
    ...
    {
        return str_ireplace(['{workflowId}'], [$this->workflowId], self::METHOD_URL);
    }
    /**
     * @return string
     */
