...
class GetTemplates extends QueryOperation
{
    ...
    public const METHOD_URL = '/v3/template-categories/{templateCategoryId}/templates';
    /** @var string */
    ...
    {
        return str_ireplace(['{templateCategoryId}'], [$this->templateCategoryId], self::METHOD_URL);
    }
    /**
