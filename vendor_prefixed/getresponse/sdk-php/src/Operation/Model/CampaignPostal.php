...
class CampaignPostal extends BaseModel
{
    ...
    {
        $data = ['addPostalToMessages' => $this->addPostalToMessages, 'city' => $this->city, 'companyName' => $this->companyName, 'country' => $this->country, 'design' => $this->design, 'state' => $this->state, 'street' => $this->street, 'zipCode' => $this->zipCode];
