...
class TemplateDetails extends BaseModel
{
    /** @var string */
    ...
    {
        $data = ['templateId' => $this->templateId, 'href' => $this->href, 'isFavourite' => $this->isFavourite, 'category' => $this->category, 'colorVariants' => $this->colorVariants];
