...
class UpdateContact extends BaseModel
{
    ...
    {
        $data = ['name' => $this->name, 'campaign' => $this->campaign, 'email' => $this->email, 'dayOfCycle' => $this->dayOfCycle, 'scoring' => $this->scoring, 'note' => $this->note, 'tags' => $this->tags, 'customFieldValues' => $this->customFieldValues];
