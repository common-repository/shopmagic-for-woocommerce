...
class ContactGeolocation extends BaseModel
{
    ...
    {
        $data = ['latitude' => $this->latitude, 'longitude' => $this->longitude, 'continentCode' => $this->continentCode, 'countryCode' => $this->countryCode, 'region' => $this->region, 'postalCode' => $this->postalCode, 'dmaCode' => $this->dmaCode, 'city' => $this->city];
