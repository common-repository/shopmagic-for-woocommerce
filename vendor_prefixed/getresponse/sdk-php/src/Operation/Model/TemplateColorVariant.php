...
class TemplateColorVariant extends BaseModel
{
    ...
    {
        $data = ['templateColorId' => $this->templateColorId, 'name' => $this->name, 'colorHex' => $this->colorHex, 'thumbnail' => $this->thumbnail, 'preview' => $this->preview, 'href' => $this->href, 'template' => $this->template, 'htmlContent' => $this->htmlContent];
