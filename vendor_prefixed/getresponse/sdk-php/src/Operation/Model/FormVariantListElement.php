...
class FormVariantListElement extends BaseModel
{
    ...
    {
        $data = ['formId' => $this->formId, 'webformId' => $this->webformId, 'variant' => $this->variant, 'variantName' => $this->variantName, 'winner' => $this->winner, 'status' => $this->status, 'createdOn' => $this->createdOn, 'numberOfVisitors' => $this->numberOfVisitors, 'numberOfUniqueVisitors' => $this->numberOfUniqueVisitors, 'numberOfSubscribers' => $this->numberOfSubscribers, 'subscriptionRate' => $this->subscriptionRate];
