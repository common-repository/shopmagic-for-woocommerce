...
class NewsletterSendSettings extends BaseModel
{
    ...
    {
        $data = ['selectedCampaigns' => $this->selectedCampaigns, 'selectedSegments' => $this->selectedSegments, 'selectedSuppressions' => $this->selectedSuppressions, 'excludedCampaigns' => $this->excludedCampaigns, 'excludedSegments' => $this->excludedSegments, 'selectedContacts' => $this->selectedContacts, 'timeTravel' => $this->timeTravel, 'perfectTiming' => $this->perfectTiming];
