...
class WorkflowListElement extends BaseModel
{
    ...
    {
        $data = ['workflowId' => $this->workflowId, 'name' => $this->name, 'status' => $this->status, 'dateStart' => $this->dateStart, 'dateStop' => $this->dateStop, 'subscriberStatistics' => $this->subscriberStatistics];
