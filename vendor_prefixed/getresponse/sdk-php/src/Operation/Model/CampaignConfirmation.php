...
class CampaignConfirmation extends BaseModel
{
    ...
    {
        $data = ['fromField' => $this->fromField, 'redirectType' => $this->redirectType, 'mimeType' => $this->mimeType, 'redirectUrl' => $this->redirectUrl, 'replyTo' => $this->replyTo, 'subscriptionConfirmationBodyId' => $this->subscriptionConfirmationBodyId, 'subscriptionConfirmationSubjectId' => $this->subscriptionConfirmationSubjectId];
