...
class LinkNotClickedCondition extends ConditionType
{
    ...
    {
        $data = ['operatorType' => $this->operatorType, 'operator' => $this->operator, 'dateOperator' => $this->dateOperator, 'value' => $this->value, 'scope' => $this->scope, 'clickTrackId' => $this->clickTrackId];
