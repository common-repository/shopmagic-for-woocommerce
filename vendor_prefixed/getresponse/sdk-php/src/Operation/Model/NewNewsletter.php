...
class NewNewsletter extends BaseModel
{
     ...
     */
    public function __construct($subject, FromFieldReference $fromField, CampaignReference $campaign, MessageContent $content, NewsletterSendSettings $sendSettings)
    {
    ...
    {
        $data = ['flags' => $this->flags, 'name' => $this->name, 'type' => $this->type, 'editor' => $this->editor, 'subject' => $this->subject, 'fromField' => $this->fromField, 'replyTo' => $this->replyTo, 'campaign' => $this->campaign, 'sendOn' => $this->sendOn, 'content' => $this->content, 'attachments' => $this->attachments, 'sendSettings' => $this->sendSettings];
