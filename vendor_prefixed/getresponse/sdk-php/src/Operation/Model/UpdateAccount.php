...
class UpdateAccount extends BaseModel
{
    ...
    {
        $data = ['firstName' => $this->firstName, 'lastName' => $this->lastName, 'companyName' => $this->companyName, 'phone' => $this->phone, 'state' => $this->state, 'city' => $this->city, 'street' => $this->street, 'zipCode' => $this->zipCode, 'numberOfEmployees' => $this->numberOfEmployees, 'timeFormat' => $this->timeFormat];
