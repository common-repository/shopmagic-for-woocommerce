...
class WebformListElement extends BaseModel
{
    ...
    {
        $data = ['webformId' => $this->webformId, 'name' => $this->name, 'href' => $this->href, 'scriptUrl' => $this->scriptUrl, 'status' => $this->status, 'modifiedOn' => $this->modifiedOn, 'statistics' => $this->statistics, 'campaign' => $this->campaign];
