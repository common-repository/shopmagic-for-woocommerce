...
class CustomFieldDetail extends BaseModel
{
    ...
    {
        $data = ['customFieldId' => $this->customFieldId, 'href' => $this->href, 'name' => $this->name, 'fieldType' => $this->fieldType, 'format' => $this->format, 'valueType' => $this->valueType, 'type' => $this->type, 'hidden' => $this->hidden, 'values' => $this->values];
