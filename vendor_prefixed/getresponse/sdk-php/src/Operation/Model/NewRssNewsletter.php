...
class NewRssNewsletter extends BaseModel
{
     ...
     */
    public function __construct($rssFeedUrl, $subject, StatusEnum $status, FromFieldReference $fromField, MessageContent $content, RssNewsletterSendSettings $sendSettings)
    {
    ...
    {
        $data = ['flags' => $this->flags, 'rssFeedUrl' => $this->rssFeedUrl, 'subject' => $this->subject, 'name' => $this->name, 'status' => $this->status, 'editor' => $this->editor, 'fromField' => $this->fromField, 'replyTo' => $this->replyTo, 'content' => $this->content, 'sendSettings' => $this->sendSettings];
