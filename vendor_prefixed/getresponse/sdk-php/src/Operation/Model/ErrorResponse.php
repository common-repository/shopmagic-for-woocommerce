...
class ErrorResponse extends BaseModel
{
    ...
    {
        $data = ['httpStatus' => $this->httpStatus, 'code' => $this->code, 'codeDescription' => $this->codeDescription, 'message' => $this->message, 'moreInfo' => $this->moreInfo, 'context' => $this->context, 'uuid' => $this->uuid];
