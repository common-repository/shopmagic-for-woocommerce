...
namespace ShopMagicVendor\GuzzleHttp\Psr7;

use InvalidArgumentException;
use ShopMagicVendor\Psr\Http\Message\ServerRequestInterface;
use ShopMagicVendor\Psr\Http\Message\StreamInterface;
use ShopMagicVendor\Psr\Http\Message\UploadedFileInterface;
use ShopMagicVendor\Psr\Http\Message\UriInterface;
/**
