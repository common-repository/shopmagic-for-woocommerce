...
use WPDesk\ShopMagic\Customer\Interceptor\SessionCustomerProvider;
...
use WPDesk\ShopMagic\Frontend\Session\CompositeSessionPersistence;
use WPDesk\ShopMagic\Frontend\Session\CookiePersistence;
use WPDesk\ShopMagic\Frontend\Session\SessionPersistence;
use WPDesk\ShopMagic\Frontend\Session\WcSessionPersistence;
...
return [
	...
	'hookable.init'                                => [
		...
		autowire( MergeGuestUserOnRegistration::class ),
	],
	...
	CustomerProvider::class                        => autowire( CompositeCustomerProvider::class )
		->constructorParameter(
			'providers',
			[
				get( SessionCustomerProvider::class ),
				get( RegisteredCustomerProvider::class ),
			]
		),
	...
	SessionPersistence::class                      => autowire( CompositeSessionPersistence::class )
		->constructorParameter(
			'persistence',
			[
				get( WcSessionPersistence::class ),
				get( CookiePersistence::class ),
			]
		),
